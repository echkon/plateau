...
gradient_list = load_gradients_csv('gradient_data_5d.csv')
...
plt.yscale("log")
plt.title('PauliTwoDesign Gradient Analysis')
plt.legend()
plt.grid(True, which="both", ls="--")
plt.savefig('5d_plot.eps', format='eps')
plt.savefig('5d_plot.png')
plt.show()